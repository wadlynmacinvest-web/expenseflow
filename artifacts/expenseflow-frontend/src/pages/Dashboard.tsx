      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "32px 20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "12px", marginBottom: "20px" }}>
          <div style={card()}>
            ...
            <p style={{ fontSize: "1.5rem", fontWeight: 800, color: "#047857", marginTop: "6px" }}>
          ...
          <div style={card()}>
            ...
            <p style={{ fontSize: "1.5rem", fontWeight: 800, color: "#dc2626", marginTop: "6px" }}>
          ...
          <div style={card()}>
            ...
            <p style={{ fontSize: "1.5rem", fontWeight: 800, marginTop: "6px", color: overview && overview.totalProfit >= 0 ? "#059669" : "#ef4444" }}>
          ...
          <div style={card()}>
            ...
            <p style={{ fontSize: "1.5rem", fontWeight: 800, color: "#ea580c", marginTop: "6px" }}>
          ...
          <div style={card()}>
            ...
            <p style={{ fontSize: "1.5rem", fontWeight: 800, color: "#0ea5a4", marginTop: "6px" }}>
          ...
          {budgetRemaining !== null && (
            <div style={card()}>
              ...
              <p style={{
                fontSize: "1.5rem", fontWeight: 800, marginTop: "6px",
